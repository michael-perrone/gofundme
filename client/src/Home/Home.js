...
const Home = () => {
    ...
    return (
        <div id={styles.homeContainer}>
            ...
            <p className="details">The Rivera's are a beautiful family who recently had to experience the passing of Luz Rivera. Luz was a mother to six wonderful children and a wife to a loving husband of twenty years. She was also a school teacher who's salary greatly contributed to her families financial means. Sadly, after a long battle with breast cancer in which she never stopped fighting, she recently passed away. Miguel Rivera, the father of the children and husband to Luz, was unable for months to work due to needing to be available to take care of his wife. Miguel has refusen to give up and continues to keep fighting just as his wife would have wanted him to. He is now working twelve hour days because he does not want his family to be removed from their home. Miguel's thirteen year old daughter now has the responsibility of watching the other five children throughout the day so he can work. While the children are continuously grieving, they also now have to deal with their dad working overtime. The children are growing out of their clothes, and the financial hardships continue to pile up for the Rivera's.</p>
            <div>
                <p id="first-spec-p" className="spec-p">How you can help</p>
            </div>
            <p className="details">2020 has been a tough year for everyone, but it has been an especially tough year for the Rivera family. This year, like last year, I have adopted a family through the Salvation Army, and I feel blessed to have the opportunity to have adopted this family. I am asking you to please help me with covering as many of their financial expenses as possible. All donations will go towards the Rivera's dire financial needs. This includes food, bills and utlities, clothing, and educational material. Please help by sending whatever you can to my venmo. I am choosing to use venmo because websites like GoFundMe choose to take an unnecessary percentage of money donated. My venmo is @mfc-tennis. Please know every cent donated will be immediately forwarded from me to Miguel Rivera. I am hoping to reach a donation goal of $5000 dollars. I know this won't cover all of the Rivera's expenses, but it still would be a tremendous help. Please join me in donating and please share this with others.</p>
            <div>
